...
class Squares2 {
  ...
  constructor(name) {
      ...
      this.three_light.position.set(7, 5, 5)
      ...
      this.material_left = new THREE.MeshBasicMaterial( {color: this.color_1} );
      this.square_mesh_left = new THREE.Mesh( this.square_geom_left, this.material_left)
      this.three_scene.add(  this.square_mesh_left );
      ...
      this.material_right = new THREE.MeshBasicMaterial( {color: this.color_2} );
      this.square_mesh_right = new THREE.Mesh( this.square_geom_right, this.material_right)
      this.three_scene.add(  this.square_mesh_right );
      ...
      this.material_bottom = new THREE.MeshBasicMaterial( {color: this.color_3} );
      this.square_mesh_bottom = new THREE.Mesh( this.square_geom_bottom, this.material_bottom)
      this.three_scene.add(  this.square_mesh_bottom );
